...
const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col items-center  justify-center  min-h-screen bg-hero-background bg-clip-content bg-no-repeat">
      {/* Web Name */}
      ...
      <svg
        ...
        className="absolute md:-bottom-8 bottom-0 md:block hidden"
      >
        <path
          fill=" #e5e7eb"
          fillOpacity="1"
